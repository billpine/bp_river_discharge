...
plot(dis_mat2, xlab = "Month", ylab = "Year",
     breaks = c(-20000, -10000, 0, 10000, 85000),
     fmt.key="%.0f",
     main = "Discharge",
     col = mypallette)
...
include_years <- as.character(as.numeric(2005:2020))
...
include_years <- as.character(as.numeric(2015:2017))
...
include_years <- as.character(as.numeric(2018:2020))
