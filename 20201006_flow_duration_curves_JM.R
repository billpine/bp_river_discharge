...
disE  = dis[dis$dates>='1950-01-01' & dis$dates<='2020-09-15',]  
...
legend("topright", legend = c("1922-2020", "2005-2012"), lty = 1, col = c("black", "red"))
...
legend("topright", legend = c("1922-2020", "2013-2020"), lty = 1, col = c("black", "red"))
abline(h = log(5000), lwd = 2, col = 'blue', lty = 2)
axis(1, labels = c("0%", "20%", "40%", "60%", "80%", "100%"), at = c(0, 20, 40, 60, 80, 100))
